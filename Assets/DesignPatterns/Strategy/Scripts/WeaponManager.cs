...
public class WeaponManager : MonoBehaviour
{
    ...
    private void ChangeWeapon(WeaponType weaponType)
    {
        ...
        //ex) Bullet -> Sword로 변경할 건데 Bullet의 컴포넌트가 남아있으면
        //안되기 때문
        ...
        switch(weaponType)
        {
            case WeaponType.Bullet:         
                iwp = gameObject.AddComponent<Bullet>(); //접근점을 총알로 변경합니다.
                selected_weapon = _bullet; break; // 해당 무기를 선택합니다.
    ...
    //무기 선택 클래스의 기능들을 통해 인터페이스로 구현한 클래스에 대한 설정을 변경합니다.(디버그)
